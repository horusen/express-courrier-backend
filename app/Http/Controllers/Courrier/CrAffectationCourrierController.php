...
use App\Models\Courrier\CrAffectationCourrier;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\DB;

class CrAffectationCourrierController extends LaravelController
{
    ...
    public function getAll(Request $request)
    {
        ...
        $query = CrAffectationCourrier::query();
    ...
    {
        if($value) {
            $query->WhereHas('cr_courrier', function ($q) use ($value) {
                $q->where('libelle', 'like', "%" .$value . "%");
                $q->orWhere('objet', 'like', "%" .$value . "%");
            });
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $item = CrAffectationCourrier::findOrFail($id);
    ...
    public function attachAffectation(Request $request)
    {
        ...
        $item = CrAffectationCourrier::find($item_id);
    ...
    public function getAffectation(CrAffectationCourrier $CrAffectationCourrier)
    {
